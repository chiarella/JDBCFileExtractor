...
import Utils.FormatarZeroOuNulo;
...
public class GerarArquivoTxt {
	...
	public static void gerartxt() {
		...
		try {
			String content = "c:/Arquivos/Arquivo gerado.txt";
			...
			for (ContatoBean contato : contatos) {
				...
				texto.append("Tel.: " + FormatarZeroOuNulo.zeroOuNull(contato.getTel()));
				texto.append("Cel.: " + FormatarZeroOuNulo.zeroOuNull(contato.getCel()));
				texto.append("email: " + FormatarZeroOuNulo.zeroOuNull(contato.getEmail()));
				texto.append("Observações: " + FormatarZeroOuNulo.zeroOuNull(contato.getObservacoes()));
